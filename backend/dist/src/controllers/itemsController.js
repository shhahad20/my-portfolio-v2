...
export const repositories = (req, res, next) => {
...
export const recent = async (req, res, next) => {
    try {
        const [{ data: repositories, error: repoError }, { data: components, error: componentError }, { data: social_media, error: socialError }] = await Promise.all([
